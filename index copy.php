  ...
  <!-- <script>
    $(document).ready(function(){
      ...
      function sendHeaderTextData() {
        ...
        let headerText = encoder.encode("Uber Resto\nJln. Hayam Wuruk\n");
...
<body unresolved>
  ...
  <div id="cards">
    ...
    <paper-card>
      <div class="card-content">
        ...
        <!-- <textarea name="message" id="message">ZZZZZ</textarea> -->
    ...
    <paper-card>
      <div class="card-content">
        <paper-textarea id="messagez" label="Enter Message">TEST PRINT</paper-textarea>
      </div>
    </paper-card>
  </div>
  ...
  <!-- <script>
    ...
    document.addEventListener('WebComponentsReady', function () {
      ...
      let data;
      progress.hidden = true;
      let messagez = document.querySelector('#messagez');
      let table_barang = document.querySelector("#table_barang");
